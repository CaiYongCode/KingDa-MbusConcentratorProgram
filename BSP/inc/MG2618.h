...
#define CIMI_Command_EN      1  //查询国际 ID 号
#define CGMR_Command_EN      1  //获取产品版本号
...
#define CGATT_Command_EN       0    //设置 GPRS 业务 
...
// 网络参数指令 
#define ZPNUM_Command_EN         1    //设置 APN，用户名，密码 
#define ZPPPOPEN_Command_EN      1    //打开 GPRS 数据连接 
#define ZPPPCLOSE_Command_EN     0   //关闭 GPRS 数据连接 
#define ZIPGETIP_Command_EN      1    //查询当前模块 IP 地址值 
#define ZDNSSERV_Command_EN      0    //设置 DNS 服务器的 IP 地址 
#define ZDNSGETIP_Command_EN     0   //获取对应 Internet 域名的 IP 地址 
//TCP 连接指令 
#define ZIPSETUP_Command_EN      1   //建立 TCP 服务器链接
#define ZIPSEND_Command_EN       1  //向目标地址发送 TCP 数据 
#define ZPPPSTATUS_Command_EN    0   //查询 GPRS 连接状态 
#define ZIPCLOSE_Command_EN      1   //关闭 TCP 链接
