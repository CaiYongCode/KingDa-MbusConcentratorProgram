...
// 网络参数指令 
/*078*/ "+ZPNUM",           //设置 APN，用户名，密码 
/*079*/ "+ZPPPOPEN",        //打开 GPRS 数据连接 
/*080*/ "+ZPPPCLOSE",       //关闭 GPRS 数据连接 
/*081*/ "+ZIPGETIP",       //查询当前模块 IP 地址值 
/*082*/ "+ZDNSSERV",        //设置 DNS 服务器的 IP 地址 
/*083*/ "+ZDNSGETIP",       //获取对应 Internet 域名的 IP 地址 
//TCP 连接指令 
/*084*/ "+ZIPSETUP",        //建立 TCP 服务器链接
/*085*/ "+ZIPSEND" ,        //向目标地址发送 TCP 数据 
/*086*/ "+ZPPPSTATUS",      //查询 GPRS 连接状态 
/*087*/ "+ZIPCLOSE" ,       //关闭 TCP 链接
/*088*/ "+ZIPSTATUS",       //查询当前 TCP 连接状态 
// UDP 连接指令 
/*089*/ "+ZIPSETUPU",       //建立 UDP 服务器链接 
/*090*/ "+ZIPSENDU",        //向 UDP 服务器发送数据 
/*091*/ "+ZIPSTATUSU",      //查询 UDP 状态
/*092*/ "+ZIPCLOSEU",       //关闭 UDP 链接
// SERVER 指令 
